...
bool FlutterWindow::OnCreate() {
  ...
  // Register file operations handler
  file_ops_handler_ = std::make_unique<FileOpsHandler>(flutter_controller_->engine());

  // Register window controller
  window_controller_ = std::make_unique<WindowController>(
